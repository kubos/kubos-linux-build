...
#
###############################################
KUBOS_COMMAND_AND_CONTROL_VERSION = master
...
define KUBOS_COMMAND_AND_CONTROL_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0755 $(@D)/$(KUBOS_REPO_COMMAND_AND_CONTROL_PATH)/$(KUBOS_CNC_ARTIFACT_BUILD_PATH)/cmd-control-daemon $(TARGET_DIR)/usr/sbin/kubos-command-and-control
endef
